<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebFormBorrarAlumno.aspx.cs" Inherits="ASP.WebFormBorrarAlumno" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <link rel="stylesheet" href="CSS/EstilosBorrarAlumno.css" type="text/css" />
</head>
<body>
    <asp:Label Text="Borrar" runat="server" CssClass="titulo"></asp:Label>
